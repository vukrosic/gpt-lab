...
to test this on two GPUs (requires at least 8GB of VRAM each unless you mess with hyperparameters):
```
...
- [ ] implement ability to run on a single GPU without a hacky debug config
